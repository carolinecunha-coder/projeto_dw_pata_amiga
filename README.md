...
### P1 — Onde está o gargalo de entrega?

Analisar o tempo médio dos intervalos do pedido até a entrega,
comparando os resultados por porte da loja.

### P2 — Qual categoria concentra o faturamento?

Identificar as categorias com maior participação no faturamento
e verificar a categoria líder em cada porte de loja.

### P3 — Como se comportam os canais de venda?

Comparar o ticket médio dos pedidos com e sem desconto por canal
e identificar a participação de cada canal no faturamento.

### P4 — Como o faturamento se distribui pelas praças?

Ratear o faturamento das lojas entre as praças atendidas utilizando
o fator público e relacionar o resultado aos domicílios com pets.

### P5 — Onde existe oportunidade para uma nova loja?

Identificar cidades com maior intensidade de itens por mil habitantes
e considerar também o tempo médio de entrega, respeitando a faixa
de franquia definida no projeto.
...
## Resultados e respostas às perguntas
